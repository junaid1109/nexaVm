  ...
  <div class="partners-page">
    <div class="partners-header">
      ...
      <div class="header-content">
        ...
        <p class="subtitle">Expanding our reach through strategic channel partnerships</p>
      </div>
    </div>
...
// Filter only channel partners
const channelPartners = computed(() => {
  return partners.value.filter(p => p.partnerType === 'Channel partners')
})

// Get unique countries (sorted, removing duplicates)
const uniqueCountries = computed(() => {
  const countries = [...new Set(channelPartners.value.map(p => p.country))]
  return countries.sort()
})

// Get partners by country
function getPartnersByCountry(country: string) {
  return channelPartners.value.filter(p => p.country === country)
}
